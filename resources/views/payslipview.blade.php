@php $active = 'payslipview' @endphp
@extends('layouts.main')
@section('title','payslipview')
@section('content')
...
<div class="payslip-card">
    <div class="company-info">
        <div class="info">
            <p> <b>ESCA Management Corporation</b>
        ...
        <div class="logo"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3O-DrKHDSzSKsmyloi_FRJjzhf7KBPGR6CA&usqp=CAU"> </div>
    </div>
        ...
        <div class="left">
            <table>
                ...
                <tr>
                    ...
                    <td class="value">Dexter Arvin E Abagon</td>
                </tr>
                <tr>
